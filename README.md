...
<head>
  ...
  <style>
    ...
    *{ box-sizing:border-box; }
    ...
    /* ===== Logo FIRST ===== */
    .logo-row{ display:flex; justify-content:flex-end; }
    .logo-row img{ max-width:260px; height:auto; display:block; } /* doubled size */

    /* ===== Title + Subtitle (together) ===== */
    .title-block{ margin-top:10px; }
    .title{
      font-family:var(--font-bold); font-weight:700;
      font-size:22pt; line-height:1.25; color:#111111;
      margin:0; padding:0;
    }
    .subtitle{
      font-family:var(--font-bold); font-weight:700;
      font-size:13pt; /* 1pt smaller */
      color:#111111;  /* same as title */
      margin:0; padding-top:2px;
    }
    .pad-after-title-block{ height:18pt; } /* after subtitle */
    ...
    .muted{ color:var(--muted); font-size:10pt; margin-top:6px; }
...
<body>
  <main>
    <!-- Logo first -->
    <div class="logo-row">
      https://seekvectorlogo.com/wp-content/uploads/2019/05/aggreko-vector-logo.png
    </div>
      ...
      <table>
        ...
        <tbody>
          ...
          <tr>
            ...
            <td>MW</td>
            <td><input type="text" id="avgDemandMW" name="avgDemandMW" /></td>
          </tr>
          <tr>
          ...
          <!-- Newly reinstated rows -->
          <tr>
            <td>Altitude</td>
            <td>m</td>
            <td><input type="text" id="altitudeM" name="altitudeM" /></td>
          </tr>
          <tr>
            <td>Voltage</td>
            <td>V</td>
            <td><input type="text" id="voltageV" name="voltageV" /></td>
          </tr>
          <tr>
            <td>Accommodation</td>
